...
<body class="body1">
	<div>
		<div>
			...
			<div class="w3-sidebar w3-bar-block w3-collapse w3-card-2 w3-animate-left" stylRe="width:100px;"
				id="mySidebar">
			...
			<div class="topnav">
				<div class="parent2">
					<div class="test1 bimage1"><a href="#"><img
								src="https://i.pinimg.com/originals/c1/17/25/c117254de6fbc71a924865a5ddee1faf.png"
								title="IT Solution" style="border-radius: 50%;" width="42" height="42"></a></div>
					<div class="test2"><a href="#"><img src="image/fb-logo.png" title="Event Management" width="42"
								height="42" style="border-radius: 50%;"></a></div>
					<div class="test3"><a href="#"><img
								src="https://cdn.icon-icons.com/icons2/2351/PNG/512/logo_github_icon_143196.png"
								title="Photography" width="42" height="42" style="border-radius: 50%;"></a></div>
					<div class="test4"><a href="#"><img src="image/twitter-logo.png" title="Tution"
								style="border-radius: 50%;" width="42" height="42"></a></div>
					<div class="mask2"><i class="fa fa-home fa-3x"></i></div>
				</div>
				<a class="active navlink" href="index.php" style="margin: 0px 0px 0px 100px;">Student Posts</a>
		...
		?>
			...
			if($utype_db == "teacher")
			 ...
			 ?>
				...
				<?php 
        if ($utype_db != "teacher" && $utype_db != "student") {
            echo '<a class="navlink" href="aboutus.php">About</a>';
        }
    ?>
			...
			<div style="width: 1000px; margin: 0 auto;">
				...
				<ul>
					...
					<div class="settingsleftcontent">
						<ul>
							<li><a href="profile.php?uid='.$user.'" >My Posts</a></li>
...
if ($query2 && $query2->num_rows > 0) {
    ...
    // Handle the case where $tutor_info is null or doesn't contain the expected keys
    // For example, you can set default values or display a message indicating no tutor info found
	$uinsname_db = "";
	$umedium_db = "";
	$uclass_db = ""; 
    $upresub_db = "";
