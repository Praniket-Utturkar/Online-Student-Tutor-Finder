...
if (isset($_POST['login'])) {
    if (isset($_POST['email']) && isset($_POST['password'])) {
        ...
        if ($get_user_email) {
            ...
            $error_message = "Wrong username or password"; // Set error message
        }
    }
}
$acemails = "";
...
<body class="">
    <div>
        <div>
            ...
            <div class="w3-sidebar w3-bar-block w3-collapse w3-card-2 w3-animate-left" style="width:100px;"
                id="mySidebar">
            ...
            <div class="nfeedleft " style="background-color: unset;">
                <div>
                    <div class="testbox" style="height: 280px;">
                        <h1>Login</h1>
                        <?php if ($error_message != "") echo '<div class="error-message" style="color: red;">' . $error_message . '</div>'; ?>
                        <form action="" method="post">
                            ...
                            <div>
                                <div style="float: right; width: 35%; margin-top: 10px;">
                                    <input type="submit" class="sub_button" name="login" id="name"
                                        value="Login" /><br><br>
                                </div>
                                <div style="width: 50%; float: left; padding: 10px 0 5px 4px">
                                    <p>Forget your password?<a href="#" style="font-weight: bold;">Click here</a>.</p>
                                    <p>Not registered yet?<a href="registration.php" style="font-weight: bold;">Register
                                            here</a>.</p>
                                </div>
                            </div>
                        </form>
